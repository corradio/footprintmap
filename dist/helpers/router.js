import { createBrowserHistory, createHashHistory } from '../pkg/history.js'; // Use BrowserHistory in the web browser and HashHistory
...
export const history = window.isCordova ? createHashHistory() : createBrowserHistory(); // TODO: Deprecate in favor of React Router useParams (requires move to React)
