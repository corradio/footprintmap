...
const modeOrder = ['nuclear', // 'geothermal',
'biomass', 'coal', 'wind', 'solar', 'hydro', // 'hydro storage',
// 'battery storage',
'gas', 'oil', 'unknown'];
...
export { modeColor, modeOrder, PRODUCTION_MODES, STORAGE_MODES, DEFAULT_FLAG_SIZE, CARBON_INTENSITY_DOMAIN, FOSSIL_FUEL_KEYS };