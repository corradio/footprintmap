...
const CountryHistoryEmissionsGraph = ({isMobile, selectedTimeIndex, electricityMixMode}) => {
  ...
  const {data, layerKeys, layerStroke, layerFill, markerFill, valueAxisLabel} = useMemo(() => prepareGraphData(historyData, electricityMixMode), [historyData, electricityMixMode]);
