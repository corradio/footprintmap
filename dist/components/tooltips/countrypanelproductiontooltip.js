...
const CountryPanelProductionTooltip = ({
  ...
  return /*#__PURE__*/React.createElement(Tooltip, {
    ...
    dangerouslySetInnerHTML: {
      __html: `${zoneData.year}: ${headline}`
    }
  }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(MetricRatio, {
    value: usage,
    total: totalElectricity,
    format: format
  }), null && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), __('tooltips.utilizing'), " ", /*#__PURE__*/React.createElement("b", null, getRatioPercent(usage, capacity), " %"), " ", __('tooltips.ofinstalled'), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(MetricRatio, {
    value: usage,
    total: capacity,
    format: format
  })), null && !displayByEmissions && (isFinite(co2Intensity) || usage !== 0) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), __('tooltips.withcarbonintensity'), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(CarbonIntensity, {
    intensity: co2Intensity
  }), /*#__PURE__*/React.createElement("small", null, " (", __('country-panel.source'), ": ", co2IntensitySource || '?', ")")));
};
