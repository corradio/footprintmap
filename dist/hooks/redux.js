...
import { matchPath } from '../pkg/react-router.js';
import { keys, sortBy } from '../pkg/lodash.js';
...
export function useCurrentZoneExchangeKeys() {
  ...
  return useMemo(() => isConsumption ? sortBy(keys(zoneData.exchange)) : [], [isConsumption, zoneData]);
}
