...
import { r as reactIs, h as hoistNonReactStatics_cjs } from './common/hoist-non-react-statics.cjs-2140ebcd.js';
...
function qe(e, t, n) {
  ...
  var C,
    ...
    return function (e, t, n, r) {
      ...
      return t.style && g.style !== t.style && (C.style = v({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = w, /*#__PURE__*/react.createElement(_, C);
    }(C, e, t, P);
  };
